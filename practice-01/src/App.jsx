...
// by map or foreach it starts a loop now on the accesing that elemnt we have appplied loop now moving forward to apply at card 
const App = () => {
  const jobOpenings = [
    {
  ...
  return (
    ...
    {jobOpenings.map(function (elem) {
      return <Card company={elem.companyName} post={elem.datePosted} title={elem.post} logo={elem.brandLogo} fr={elem.tag1} sc={elem.tag2}/>
    })}
    </div>
